...
const Fotteer = () => {
  return (
    <div className="">
      <footer className="flex flex-col items-center  bg-red-400 text-center text-white ">
        <div className="container p-6">
          <div className="">
            <p className="tablte:flex tablte:flex-row tablte:items-center tablte:justify-center mobile:flex mobile:flex-col">
        ...
        <div className="w-full p-4 text-center">
          <footer className="flex flex-col items-center bg-transparent text-center text-surface ">
            <div className="container px-6 pt-6">
              <div className="mb-6 flex mobile:justify-center mobile:mx-7 tablte:gap-7 tablte:justify-between flex-wrap ">
                <a
                  href="#!"
                  type="button"
