    ...
    <div>
      ...
      <div>
        <p className="text-2xl text-center ">
          {user && user.member == "A" ? "Admin" : "Member"} in These website
          <br />
          ...
          <div className="w-[50%]">
            ...
            <div className="mt-5 mb-5">
              <label className="input input-bordered flex items-center gap-2">
                <input
                  disabled
                  type="text"
                  defaultValue={user && user.member == "A" ? "Admin" : "Member"}
                  className="grow"
                  placeholder="member"
                />
              </label>
            ...
            <div className="flex justify-center">
              <button
                ...
                onClick={() => navigation(`/admin/edite/${user.id}`)}
              >
                Edite Profile
              </button>
            </div>
