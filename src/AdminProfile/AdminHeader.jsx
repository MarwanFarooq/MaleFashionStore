      ...
      <div className="navbar text-black bg-white">
        ...
        <div className="flex-none">
          ...
          <div className="dropdown dropdown-end">
            ...
            <ul
              tabIndex={0}
              className="menu menu-sm dropdown-content mt-3 relative z-10 p-2 shadow  bg-white text-black rounded-box w-52"
            >
              <li>
                <button onClick={() => navigation("/admin")}>
                  <span>Home</span>
                </button>
              </li>
              <li>
              ...
              <li>
                <button onClick={() => navigation("/admin/profile")}>
                  Profile
